...
//   id: (['deposit', 'withdraw', 'kyc', 'follow', 'trust'] as Array<keyof TodoVO>)[index],
//   title: ['充值审核', '提现审核', '实名认证审核', '用户跟单信号源审核', '托管跟单审核'][index],
//   avatar: [null, null, null, null, null][index],
//   type: ['order_placed', 'friend_interactive', 'chat_message', 'mail', 'order_shipped'][index],
//   path: [
//     PATH_DASHBOARD.task.recharge,
//     PATH_DASHBOARD.task.without,
//     PATH_DASHBOARD.task.realName,
//     PATH_DASHBOARD.task.source,
//     PATH_DASHBOARD.task.follow,
//   ][index],
// }));
