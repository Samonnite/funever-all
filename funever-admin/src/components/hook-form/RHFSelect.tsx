...
export function RHFMultiSelect({
  ...
  const renderValues = (selectedIds: valueType[]) => {
    const selectedItems = options.filter(
      (item) => selectedIds.length && selectedIds.includes(item.value)
    );
      ...
      render={({ field, fieldState: { error } }) => (
        <FormControl sx={sx}>
          ...
          <Select
            ...
            labelId={name}
            input={<OutlinedInput size="small" notched fullWidth label={label} error={!!error} />}
