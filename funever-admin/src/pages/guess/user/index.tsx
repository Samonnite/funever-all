...
import { AdminUserGuessBlock, AdminUserGuessPage } from 'api/model';
    ...
    () =>
      ({
        ...
        getDetailRowData: (params) => {
          params.successCallback(params?.data?.tranBlock!);
        },
      } as IDetailCellRendererParams<AdminUserGuessPage, AdminUserGuessBlock>),
    []
  );

  useEffect(() => {
    handleSearch({ gsid: data });
