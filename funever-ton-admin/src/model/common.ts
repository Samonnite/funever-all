...
export const goldStatusObjTextObj: Record<string, any> = {
  await: {
    text: '等待中',
    color: '#FFAB00',
  },
...
export const walletTypeObj: Record<string, any> = {
  coin: '金币',
  point: '积分',
  token: '代币',
};

export const billTypeObj = {
  user_sign: '用户签到',
  user_login: '用户登录',
  user_post: '用户发帖',
  user_invite: '邀请好友',
  match_stake: '参与竞猜',
  match_complete: '竞猜结算', // 竞猜结算
  admin_change: '后台调整', // 后台调整
  user_task: '新手任务', // 新手任务
  user_match: '下级竞猜', // 下级竞猜
  user_deposit: '用户充值', // 用户充值
};
