    ...
    items: [
      ...
      // },
      {
        ...
        children: [
          ...
          {
            title: '签到配置',
            path: PATH_DASHBOARD.system.sign.root,
          },
          {
            title: '任务配置',
            path: PATH_DASHBOARD.system.task.root,
          },
          {
            title: '币种管理',
      ...
      {
        title: '竞猜管理',
        path: PATH_DASHBOARD.guess.root,
        icon: ICONS.cart,
        children: [
          {
            title: '竞猜列表',
          ...
          // {
          //   title: '竞猜用户',
          //   path: PATH_DASHBOARD.guess.user,
          // },
        ],
      },
      {
      ...
      {
        title: '资产管理',
        path: PATH_DASHBOARD.assets.wallet,
        icon: ICONS.banking,
        children: [
          {
            title: '用户钱包查询',
          ...
          {
            title: '钱包交易记录',
            path: PATH_DASHBOARD.assets.walletRecord,
          },
          {
            title: '金币充值记录',
            path: PATH_DASHBOARD.assets.gold,
          },
        ],
      },
      {
